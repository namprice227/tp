...
import static seedu.address.logic.commands.ExitCommand.CONFIRMATION_MESSAGE;
...
public class ExitCommandTest {
    ...
    public void execute_exit_needsConfirmation() {
        CommandResult expectedCommandResult = new CommandResult(CONFIRMATION_MESSAGE, false, false, true);
